...
def view(video):
    ve = random.choice(__versions)
    device = random.choice(__devices)
    host = random.choice(__domains)

    params = urllib.parse.urlencode({
        "app_language": "fr",
        "iid": IID,  # Placeholder, replace with actual IID
        "device_id": DID,  # Placeholder, replace with actual DID
        "channel": "googleplay",
        "device_type": device,
        "ac": "wifi",
